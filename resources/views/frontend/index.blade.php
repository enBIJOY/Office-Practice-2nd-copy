	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 text-center mb-5 mb-md-0">
				<img class="img-fluid" src="{{asset('vextemp/images/watch.png')}}" alt="">
			</div>
			<div class="col-md-6 align-self-center text-center text-md-left">
				<div class="block">
					<h1 class="font-weight-bold mb-4 font-size-60">{{ __('Believe in Technology, Make the change') }}</h1>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 text-center align-self-center mb-4 mb-md-0">
        <img class="img-fluid" src="{{asset('vextemp/images/watch-2.png')}}" alt="">
      </div>
      <div class="col-md-4">
...
<section class="feature-list section">
  <div class="container">
    ...
    <div class="row mb-40">
      <div class="col-md-6 text-center mb-5 mb-lg-0">
        <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-4.png')}}" alt="">
      </div>
      <div class="col-md-6 align-self-center text-center text-md-left">
        <div class="content">
    ...
    <div class="row mb-40">
      ...
      <div class="col-md-6 order-md-2 order-1 text-center mb-5 mb-lg-0">
        <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-3.png')}}" alt="">
      </div>
    </div>
      ...
      <div class="col-md-12">
        ...
        <div class="product-slider">
          ...
          <div class="block">
            ...
            <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-1.png')}}" alt="Apple Watch">
          </div>
          ...
          <div class="block">
            ...
            <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-2.png')}}" alt="Galaxy Watch">
          </div>
          ...
          <div class="block">
            ...
            <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-4.png')}}" alt="Motorola Watch">
          </div>
          ...
          <div class="block">
            ...
            <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-7.png')}}" alt="OnePlus Watch">
          </div>
          ...
          <div class="block">
            ...
            <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-8.png')}}" alt="Oppo Watch">
          </div>
          ...
          <div class="block">
            ...
            <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-6.png')}}" alt="Realme Watch">
          </div>
          ...
          <div class="block">
            ...
            <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-5.png')}}" alt="Redmi Watch">
          </div>
          ...
          <div class="block">
            ...
            <img class="img-fluid" src="{{asset('vextemp/images/showcase/showcase-3.png')}}" alt="Xiaomi Watch">
          </div>
      ...
      <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0 text-center">
        <div class="testimonial-block">
          ...
          <div class="author-details">
            <img src="{{asset('vextemp/images/avater.png')}}" alt="Jonathon Andrew">
